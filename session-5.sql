...
almamak için IF NOT EXISTS keywordu kullanılabilir. Bu komut aynı isimli table varsa oluşturmaz ama hata da vermez. */
...
FOREIGN KEY - Başka bir tablodaki Primary Key'i referans göstermek için kullanılır. 
 ...
 INSERT INTO workers  (id, id_number, salary) VALUES(4, "76433671110", 9000);
...
/*vacation_plan2 tablosuna name sutununu siliniz*/
